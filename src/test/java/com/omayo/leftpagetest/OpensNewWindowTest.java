...
public class OpensNewWindowTest extends Base {
	...
	@Test()
	public void opensNewWindowTest() throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		opensNewWindowPage = new OpensNewWindowPage(driver);
